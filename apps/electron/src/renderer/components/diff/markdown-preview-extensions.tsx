import { highlightCode, highlightToTokens, getDisplayName } from '@tagent/core'
...
function isExternalUrl(src: string): boolean {
  return /^(?:https?:|data:|blob:|file:|tagent-file:)/i.test(src)
}
...
function createShikiCodeBlockView(initialNode: ProseMirrorNode, view: EditorView) {
  ...
  dom.dataset.tagentCodeBlock = 'true'
  ...
  setClass(mermaidHost, 'tagent-mermaid-preview hidden')
