...
export const SETTINGS_SEARCH_INDEX: SearchableTab[] = [
  {
    ...
    items: [
      { id: 'user-avatar', title: '头像', description: '更换用户头像', keywords: ['emoji', '图片', 'profile', '用户'] },
      { id: 'user-name', title: '用户名', description: '编辑显示名称', keywords: ['profile', '用户', '显示'] },
      ...
      { id: 'auto-archive', title: '自动归档', description: '超过指定天数自动归档', keywords: ['archive', '归档'] },
  ...
  },
  {
    ...
    items: [
      { id: 'add-channel', title: '添加渠道', description: '添加新的 AI 渠道', keywords: ['add', '新增'] },
  ...
  },
  {
    ...
    items: [
      { id: 'shortcut-quick-task', title: '快速任务', description: '打开快速任务窗口', keywords: ['Alt+Space'] },
      { id: 'shortcut-show-main', title: '显示主窗口', description: '显示/隐藏主窗口', keywords: ['CommandOrControl+Shift+P'] },
  ...
  },
  {
    ...
    items: [
      { id: 'theme-mode', title: '主题模式', description: '浅色/深色/跟随系统', keywords: ['theme', 'dark', 'light'] },
