...
class cs extends Qn {
  ...
  scrapeMotionValuesFromProps(t, e, n) {
    return (function (t, e, n) {
      ...
      for (const n in t)
        (N(t[n]) || N(e[n])) &&
          (s[-1 !== st.indexOf(n) ? 'attr' + n.charAt(0).toUpperCase() + n.substring(1) : n] = t[n])
      return s
    })(t, e, n)
  }
  build(t, e, n) {
...
class As {
  ...
  flatten() {
    var t
    this.animation &&
      (null === (t = this.animation.effect) || void 0 === t || t.updateTiming({ easing: 'linear' }))
  }
  play() {
    ;('finished' === this.state && this.updateFinishedPromise(),
...
function Hs(t, e, n) {
  ...
  ;(c &&
    ((e[r].interpolate = ln(e[r].offset, D(s))), (e[r].interpolatorOffsets = [...e[r].offset])),
